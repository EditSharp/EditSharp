            ...
            PlaybackReferenceClock referenceClock, bool followsReferenceClock)
        {
            ...
            try
            {
                try
                {
                    ...
                    gpuContext.DrainAndLogD3D12DebugMessages($"warm-up frame {startFrame}"); // TEMPORARY DIAGNOSTIC
                    ...
                    for (int frameIndex = startFrame + 1; frameIndex < totalFrames; frameIndex++)
                    {
                        ...
                        gpuContext.DrainAndLogD3D12DebugMessages($"frame {frameIndex}"); // TEMPORARY DIAGNOSTIC
