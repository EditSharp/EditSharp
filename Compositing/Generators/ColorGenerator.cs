...
namespace EditSharp.Compositing.Generators
{
    ...
    /// image is ACTUALLY upstream of it (see ImageGraphEvaluator's own
    ...
    internal static class ColorGenerator
    {
        public static SKImage Render(
            ColorGeneratorInputNode node, double clipSeconds, int canvasWidth, int canvasHeight, SurfacePool pool)
        {
