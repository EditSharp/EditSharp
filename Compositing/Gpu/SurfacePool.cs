...
namespace EditSharp.Compositing.Gpu
{
    ...
    /// surfaces concurrently alive within one frame (FrameCompositor.
    ...
    /// real cause was found (a precision hazard in NoiseGenerator's shader —
    ...
    /// about the proven Rgba8888 compositor path (FrameCompositor,
    /// ColorGenerator, NoiseGenerator, every existing call site) changes
