...
namespace EditSharp.Caching.ScrubProxy
{
    ...
    /// whole duration (via a SEPARATE SourceDecoder.Start call, run at a
    ...
    internal static class ScrubProxyCache
    {
        ...
        /// the existing persistent SourceDecoder pipe, and writes the
        ...
        /// SourceDecoder.Start call (its own persistent pipe, distinct
            ...
            string sourcePath, int width, int height, TimeSpan duration, DecodeHwAccelPlan plan)
        {
            ...
            using (SourceDecoder sampleDecoder = SourceDecoder.Start(
