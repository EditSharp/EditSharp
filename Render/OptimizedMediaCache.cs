...
namespace EditSharp.Render
{
    ...
    /// rewrite removed that need entirely (SkSourceDecoder is one
    ...
    /// smaller proxy — see RenderContentPreparation.ProbeVideoAsync's own
    ...
    /// its output (see RenderContentPreparation forcing
    ...
    /// RenderContentPreparation.ProbeVideoAsync's own remarks for why
    ...
    public static class OptimizedMediaCache
    {
        ...
        /// Renderer actually call (via RenderContentPreparation) so a
        ...
        /// original (see RenderContentPreparation.ProbeVideoAsync and
        /// SkClipContentSource.GetOrOpenDecoder, both of which compute a
