...
namespace EditSharp.Components.Media
{
    ...
    public enum SourceUnavailableReason
    {
        ...
        /// <summary>There's nothing to read: the input has no media, or the media has no file chosen.</summary>
        NoMedia,

        /// <summary>There's nothing to read: the input has no timeline.</summary>
        NoTimeline,
    }
